...
$sql7 = "SELECT * FROM `file` WHERE userid = '$userid'";
...
/* Media query to hide the table row on mobile devices */
...
<body>
    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="container" style="height: 100vh;padding: 1rem; cont">
            <div>
                <p class="fs-2 fw-semibold">งานกลุ่ม</p>
                ...
                <table class="table table-borderless table-sm">
                    ...
                    while ($row2 = $result3->fetch_assoc()) {
                        ...
                        <thead>
                            <tr>
                                <td scope="col" width="5%"><small>Username: </small></td>
                                <td scope="col"><small>
                                        <?php echo $userid; ?>
                                    </small></td>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td scope="col"><small>หัวข้อ: </small></td>
                                <td><small>
                                        <?php echo $row2['topic']; ?>
                                    </small></td>
                            </tr>
                            <tr class="hide-on-mobile">
                                <td scope="col" class=""><small>สมาชิก: </small></td>
                                <td>
                                    <select name="
                                    " id="">
                                    ...
                                    while ($row3 = $result5->fetch_assoc()) {
                                        ...
                                        <option value="
                                    ">
                                        <img src="<?php echo $row3['image']; ?>" alt="image profile" width="32" height="32"
                                            class="rounded-circle me-2"><small>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="row d-flex align-items-center">
                                    <div class="col-md-8 d-flex align-items-center">
                                        <input type="file" required class="form-control" multiple="multiple"
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show " id="sec2-tab-pane" role="tabpanel" aria-labelledby="sec2-tab"
                    ...
                    <div id="tableflow" class="overflow-y-scroll mt-3">
                        ...
                        <table class="table table-hover align-middle" id="myTable1">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">ไฟล์</th>
        ...
        while ($row7 = $result7->fetch_assoc()) {
            ...
            <div class="modal fade" id="new_<?php echo $row7['id'] ?>" tabindex="-1" aria-labelledby="delete"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            คุณแน่ใจที่จะกู้คืนเอกสาร <b>
                                <?php echo $row7['orginal'] ?>
                            </b> หรือไม่?
                        </div>
                        <div class="modal-footer">
                            <form action="/hci66/student/group/" method="post">
                                <input type="hidden" name="new" value="<?php echo $row7['id'] ?>">
...
//     $total_size = array_sum($_FILES['doc_file']['size']);
...
//         $bytes_uploaded += $_FILES['doc_file']['size'][$key];

//         // Calculate overall progress
//         $percent_complete = ($bytes_uploaded / $total_bytes) * 100;
