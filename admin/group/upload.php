...
$sql = "SELECT * FROM `file` WHERE userid = '$id' ORDER BY `create_at` DESC";
$result = $conn->query($sql);

$sql2 = "SELECT * FROM `file` WHERE userid = '$id' ORDER BY `create_at` DESC";
$result2 = $conn->query($sql2);

$sql3 = "SELECT * FROM `groups` WHERE userid = '$id'";
$result3 = $conn->query($sql3);
$result7 = $conn->query($sql3);

$sql4 = "SELECT * FROM `file` WHERE userid = '$id' ORDER BY `create_at` DESC";
$result4 = $conn->query($sql4);

$sql6 = "SELECT * FROM `file` WHERE userid = '$id' ORDER BY `create_at` DESC";
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="/hci66/admin/group/">งานกลุ่ม</a>
                </li>

                <li class="breadcrumb-item active">กลุ่ม
                  <?php echo $id; ?>
                </li>
              </ol>
            </nav>
                            ...
                            <tr>
                              ...
                              <td scope="row">
                                ...
                                if ($row['filetype'] == ".pdf") {
                                  ...
                                  <?php
                                } else if ($row1['filetype'] == ".jpg" or $row['filetype'] == ".jpeg") {
                                  ?>
...
if (isset($_SESSION['statusdelete']) && $_SESSION['statusdelete'] == 1) {
  ...
  $sqldelete_update = "UPDATE `users` SET `update_at`= null WHERE `username` = '$id'";
  $conn->query($sqldelete_update);
  ...
  if ($conn->query($sqldelete) === TRUE) {
    ...
    echo "<script>window.location.href = \"/hci66/admin/group/upload.php?id=$id\";</script>";
  } else {
  ...
  $sqldelete_new = "UPDATE `users` SET `update_at`= '$datetime_str' WHERE `username` = '$id'";
  $conn->query($sqldelete_new);
  $user_ip = $_SERVER['REMOTE_ADDR'];
